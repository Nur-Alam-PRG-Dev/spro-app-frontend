...
export default function FancyInfographic({ 
  ...
  return (
    <Card className="p-5 sm:p-6 mb-6 overflow-hidden relative border border-zinc-200/60 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 rounded-2xl bg-gradient-to-b from-white to-zinc-50">
      ...
      <div className="absolute top-0 left-0 w-64 h-64 bg-emerald-400/5 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2 pointer-events-none"></div>
      ...
      <div className="relative z-10">
        ...
        <div className="space-y-8">
          ...
          <div className="relative">
            <div className="flex justify-between items-end mb-2">
              <div className="w-1/3 text-left">
                <span className="block text-xl sm:text-2xl font-black text-emerald-700 leading-none mb-1">{formatCurrency(amAmount)}</span>
                <span className="text-[10px] sm:text-xs font-bold text-emerald-600/70">{amAmountPct.toFixed(1)}%</span>
              </div>
              <div className="w-1/3 text-center flex flex-col items-center justify-end pb-1">
                ...
                <span className="text-[10px] sm:text-xs font-extrabold text-emerald-900 uppercase tracking-wider">Revenue</span>
              </div>
            ...
            <div className="w-full h-3 sm:h-4 bg-zinc-100 rounded-full flex overflow-hidden shadow-inner border border-zinc-200/50">
              <div className="h-full bg-gradient-to-r from-emerald-400 to-emerald-500 relative transition-all duration-1000" style={{ width: `${amAmountPct}%` }}>
          ...
          <div className="relative">
            <div className="flex justify-between items-end mb-2">
              <div className="w-1/3 text-left">
                <span className="block text-xl sm:text-2xl font-black text-emerald-700 leading-none mb-1">{formatNum(amCount)}</span>
                <span className="text-[10px] sm:text-xs font-bold text-emerald-600/70">{amCountPct.toFixed(1)}%</span>
              </div>
              <div className="w-1/3 text-center flex flex-col items-center justify-end pb-1">
            ...
            <div className="w-full h-3 sm:h-4 bg-zinc-100 rounded-full flex overflow-hidden shadow-inner border border-zinc-200/50">
              <div className="h-full bg-gradient-to-r from-emerald-400 to-emerald-500 relative transition-all duration-1000" style={{ width: `${amCountPct}%` }}>
                <div className="absolute inset-0 bg-[linear-gradient(45deg,rgba(255,255,255,0.15)_25%,transparent_25%,transparent_50%,rgba(255,255,255,0.15)_50%,rgba(255,255,255,0.15)_75%,transparent_75%,transparent)] bg-[length:1rem_1rem]"></div>
              </div>
          ...
          <div className="relative">
            <div className="flex justify-between items-end mb-2">
              <div className="w-1/3 text-left">
                <span className="block text-xl sm:text-2xl font-black text-emerald-700 leading-none mb-1">{formatNum(amVisits)}</span>
                <span className="text-[10px] sm:text-xs font-bold text-emerald-600/70">{amVisitsPct.toFixed(1)}%</span>
              </div>
              <div className="w-1/3 text-center flex flex-col items-center justify-end pb-1">
            ...
            <div className="w-full h-3 sm:h-4 bg-zinc-100 rounded-full flex overflow-hidden shadow-inner border border-zinc-200/50">
              <div className="h-full bg-gradient-to-r from-emerald-400 to-emerald-500 relative transition-all duration-1000" style={{ width: `${amVisitsPct}%` }}>
                <div className="absolute inset-0 bg-[linear-gradient(45deg,rgba(255,255,255,0.15)_25%,transparent_25%,transparent_50%,rgba(255,255,255,0.15)_50%,rgba(255,255,255,0.15)_75%,transparent_75%,transparent)] bg-[length:1rem_1rem]"></div>
              </div>
