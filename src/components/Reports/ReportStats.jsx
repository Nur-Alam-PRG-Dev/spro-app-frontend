...
const ReportStats = () => {
  return (
    ...
    >
      ...
      <h3 className="text-xs sm:text-sm font-semibold text-indigo-100/90 tracking-wide uppercase">Report Generation</h3>
      ...
      {/* Description */}
      <p className="text-xs text-indigo-100/80 mt-2 font-medium leading-relaxed max-w-[240px]">
        Uptime for automated logistics report processing system.
      </p>

      {/* Footer Info details & progress bar */}
      <div className="mt-8 border-t border-white/10 pt-4">
        <div className="flex items-center justify-between text-xs font-semibold text-indigo-100/90 mb-2">
