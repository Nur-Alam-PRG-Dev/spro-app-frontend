...
const LearningMaterials = () => {
  return (
    <div className="w-full bg-gradient-to-r from-[#5f61e6] via-[#696cff] to-zinc-400 dark:to-zinc-800 p-5 sm:p-6 rounded-2xl flex items-center justify-between text-white shadow-sm hover:opacity-95 transition-opacity cursor-pointer">
