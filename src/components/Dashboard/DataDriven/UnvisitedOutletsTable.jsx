...
export default function UnvisitedOutletsTable({ outlets = [] }) {
  ...
  return (
    <div className="bg-gradient-to-br from-[#1e3a8a] to-[#172554] rounded-[12px] border border-blue-800/50 shadow-[0_8px_20px_rgba(30,58,138,0.3)] p-3 flex flex-col h-full overflow-hidden relative transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_12px_30px_rgba(30,58,138,0.6)]">
