  ...
  return (
    <aside className={`bg-[var(--color-sidebar-bg)] text-[var(--color-sidebar-text)] flex flex-col justify-between border-r border-[var(--color-sidebar-hover)] h-screen sticky top-0 hidden lg:flex transition-all duration-300 ease-in-out z-30 ${
      ...
      <div className={`border-t border-[var(--color-sidebar-hover)] space-y-3 ${isOpen ? 'p-3' : 'p-2'}`}>
        ...
        {isOpen ? (
          <button className="w-full flex items-center justify-center gap-2 bg-[#86efac] hover:bg-[#6ee7b7] dark:bg-emerald-950/40 dark:hover:bg-emerald-900/40 text-[#696cff] dark:text-emerald-300 py-2 px-3 rounded-xl text-sm font-semibold transition-colors shadow-sm cursor-pointer">
            <Download size={16} />
            Download Reports
          </button>
        ) : (
          <button
            ...
            className="w-full flex items-center justify-center bg-[#86efac] hover:bg-[#6ee7b7] dark:bg-emerald-950/40 dark:hover:bg-emerald-900/40 text-[#696cff] dark:text-emerald-300 p-2.5 rounded-xl transition-colors shadow-sm cursor-pointer"
          >
            <Download size={16} />
          </button>
        )}
